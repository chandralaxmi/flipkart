#Board contains 9 cells of the tictactoe game. It has function named printer which prints the current status of board, checkforwin which checks whether some player had won or not, and checkfordraw which checks whether board is in current state of draw or not
